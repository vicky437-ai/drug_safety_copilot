...
SELECT
    ...
    DRUG_START_DATE,
    AE_TERM,
    AE_CLASSIFICATION:labels[0]::VARCHAR AS AE_SOC_CLASS,
    1.0 AS AE_CLASSIFICATION_SCORE,
    AE_SEVERITY,
    AE_SERIOUSNESS,
    AE_OUTCOME,
    AE_ONSET_DATE,
...
SELECT
    ...
    NARRATIVE_TEXT,
    NARRATIVE_TYPE,
    EXTRACTED:response:primary_drug::VARCHAR AS EXTRACTED_DRUG,
    EXTRACTED:response:adverse_event::VARCHAR AS EXTRACTED_AE,
    EXTRACTED:response:severity_assessment::VARCHAR AS EXTRACTED_SEVERITY,
    EXTRACTED:response:patient_outcome::VARCHAR AS EXTRACTED_OUTCOME,
    TRY_TO_NUMBER(EXTRACTED:response:onset_days::VARCHAR) AS EXTRACTED_ONSET_DAYS,
    EXTRACTED:response:causality::VARCHAR AS EXTRACTED_CAUSALITY,
    EXTRACTED:response:dechallenge_result::VARCHAR AS DECHALLENGE_RESULT,
    EXTRACTED:response:concomitant_drugs::VARCHAR AS CONCOMITANT_DRUGS,
    NARRATIVE_SENTIMENT,
    GENERATED_AT
